...
const stats = [
  { number: "40%",    label: "avg. COD return reduction" },
  { number: "₹30k",  label: "recovered per brand/month" },
  { number: "30%",   label: "repeat purchase increase" },
];

/* PLACEHOLDER testimonial — replace with real quote */
const quote = {
  text: "Tellero paid for itself in week one. Our COD returns went from 34% to 7%.",
  name: "Priya S.",
  brand: "Glow Naturals · Bangalore",
};
